...
class PatientDetail {
  ...
  factory PatientDetail.fromJson(Map<String, Object?> json) => _$PatientDetailFromJson(json);
  ...
  final List<AdmissionSummary> admissions;

  Map<String, Object?> toJson() => _$PatientDetailToJson(this);
}
