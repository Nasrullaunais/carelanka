...
Future<HandoverDetails?> askHandoverDetails(BuildContext context) => showModalBottomSheet<HandoverDetails>(
      context: context,
...
class _DeclineDialogState extends State<_DeclineDialog> {
  ...
  Widget build(BuildContext context) => AlertDialog(
        ...
        content: TextField(
          ...
          maxLines: 3,
          autofocus: true,
          decoration: const InputDecoration(hintText: 'For example: vehicle problem'),
...
class _HandoverSheetState extends State<_HandoverSheet> {
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Hand over the patient', style: Theme.of(context).textTheme.titleLarge),
            const SizedBox(height: 16),
            TextField(
              controller: _condition,
              maxLength: 500,
              decoration: const InputDecoration(labelText: 'Patient condition on arrival (optional)'),
            ),
            ...
            TextField(
              ...
              maxLength: 1000,
              maxLines: 3,
              decoration: const InputDecoration(labelText: 'Notes for the hospital team (optional)'),
            ),
            ...
            SizedBox(
              ...
              child: FilledButton(
                onPressed: () => Navigator.pop(
                  context,
                  (notes: _blankToNull(_notes.text), patientCondition: _blankToNull(_condition.text)),
                ),
