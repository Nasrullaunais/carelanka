...
enum StaffRole {
  ...
  const StaffRole(this.json);

  factory StaffRole.fromJson(String json) => values.firstWhere(
        (e) => e.json == json,
        orElse: () => $unknown,
      );
  ...
  static List<StaffRole> get $valuesDefined => values.where((value) => value != $unknown).toList();
}
