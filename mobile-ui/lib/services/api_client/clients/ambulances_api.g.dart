...
class _AmbulancesApi implements AmbulancesApi {
  _AmbulancesApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<AmbulanceSummaryPagedResult> listAmbulances({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AmbulanceSummaryPagedResult>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/ambulances',
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late AmbulanceSummaryPagedResult _value;
    try {
      _value = AmbulanceSummaryPagedResult.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<Ambulance> createAmbulance({CreateAmbulanceRequest? body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    ...
    final _options = _setStreamType<Ambulance>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/ambulances',
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late Ambulance _value;
    try {
      _value = Ambulance.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<AmbulanceDetail> getAmbulance({required String id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AmbulanceDetail>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/ambulances/${id}',
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late AmbulanceDetail _value;
    try {
      _value = AmbulanceDetail.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<Ambulance> reinstateAmbulance({required String id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<void> reportAmbulanceLocation({
    required String id,
    ReportAmbulanceLocationRequest? body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
