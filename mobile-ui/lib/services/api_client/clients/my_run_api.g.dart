...
class _MyRunApi implements MyRunApi {
  _MyRunApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<DispatchDetail> getMyActiveDispatch() async {
  ...
  Future<DispatchDetail> updateMyDispatchStatus({
    required String id,
    UpdateMyDispatchStatusRequest? body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
