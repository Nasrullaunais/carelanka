...
final class GeneratedCrewRunService implements CrewRunService {
  ...
  @override
  Future<DispatchDetail> acknowledge(String id) => callApi(() => _run.acknowledgeMyDispatch(id: id));

  @override
  Future<DispatchDetail> decline(String id, String reason) =>
      callApi(() => _run.declineMyDispatch(id: id, body: DeclineDispatchRequest(reason: reason)));

  @override
  Future<DispatchDetail> advance(String id, DispatchStatus next) =>
      callApi(() => _run.updateMyDispatchStatus(id: id, body: UpdateMyDispatchStatusRequest(status: next)));
