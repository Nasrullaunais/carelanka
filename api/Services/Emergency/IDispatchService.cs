...
public interface IDispatchService
{
    ...
    Task<DispatchDetail> HandoverAsync(Guid dispatchId, CancellationToken cancellationToken = default);
    ...
    Task<int> RaiseUnacknowledgedAlertsAsync(CancellationToken cancellationToken = default);
}
