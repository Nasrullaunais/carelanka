...
namespace CareLanka.Api.Data.Migrations
{
    ...
    [Migration("20260925103228_Patient_RemoveMedicalProfileRecentSituation")]
    partial class Patient_RemoveMedicalProfileRecentSituation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CareLanka.Api.Data.Entities.Equipment.ReorderSuggestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("CurrentQuantityOnHand")
                        .HasColumnType("integer")
                        .HasColumnName("current_quantity_on_hand");
                    ...
                    b.Property<int?>("SuggestedThreshold")
                        .HasColumnType("integer")
                        .HasColumnName("suggested_threshold");
                    ...
                    b.HasIndex("PharmacyItemId")
                        .HasDatabaseName("ix_reorder_suggestions_pharmacy_item_id");

                    b.ToTable("reorder_suggestions", null, t =>
                        {
                            t.HasCheckConstraint("ck_reorder_suggestions_source", "source IN ('model', 'model_unavailable', 'model_rejected')");
                        });
                });
                    ...
                    b.ToTable("admissions", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_admissions_category", "category IS NULL OR category IN ('icu', 'general', 'surgical', 'maternity', 'emergency')");
                    ...
                    b.ToTable("admission_fee_rates", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_admission_fee_rates_category", "category IN ('icu', 'general', 'surgical', 'maternity', 'emergency')");
                        });
                });
            ...
            modelBuilder.Entity("CareLanka.Api.Data.Entities.Staff.Allocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("RosterProposalId")
                        .HasColumnType("uuid")
                        .HasColumnName("roster_proposal_id");
                    ...
                    b.HasIndex("CreatedByStaffId")
                        .HasDatabaseName("ix_allocations_created_by_staff_id");

                    b.HasIndex("ReplacedByAllocationId")
                        .HasDatabaseName("ix_allocations_replaced_by_allocation_id");
                    ...
                    b.HasIndex("ShiftId", "StaffMemberId")
                        .IsUnique()
                        .HasDatabaseName("ux_allocations_confirmed")
                        .HasFilter("status = 'confirmed'");

                    b.ToTable("allocations", null, t =>
                        {
                            t.HasCheckConstraint("ck_allocations_ended_reason", "ended_reason IS NULL OR ended_reason IN ('leave_approved', 'swapped_out', 'shift_cancelled', 'staff_deactivated', 'manual')");

                            t.HasCheckConstraint("ck_allocations_source", "source IN ('manual', 'agent_proposal', 'swap_request')");

                            t.HasCheckConstraint("ck_allocations_status", "status IN ('proposed', 'confirmed', 'released', 'cancelled')");
                        });
                });

            modelBuilder.Entity("CareLanka.Api.Data.Entities.Staff.LeaveRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("SwapShiftId")
                        .HasColumnType("uuid")
                        .HasColumnName("swap_shift_id");

                    b.Property<Guid?>("SwapWithStaffMemberId")
                        .HasColumnType("uuid")
                        .HasColumnName("swap_with_staff_member_id");
                    ...
                    b.HasIndex("ReviewedByStaffMemberId")
                        .HasDatabaseName("ix_leave_requests_reviewed_by_staff_member_id");

                    b.HasIndex("StaffMemberId")
                        .HasDatabaseName("ix_leave_requests_staff_id");

                    b.HasIndex("SwapShiftId")
                        .HasDatabaseName("ix_leave_requests_swap_shift_id");

                    b.HasIndex("SwapWithStaffMemberId")
                        .HasDatabaseName("ix_leave_requests_swap_with_staff_member_id");
                    ...
                    b.ToTable("leave_requests", null, t =>
                        {
                            t.HasCheckConstraint("ck_leave_requests_status", "status IN ('pending', 'approved', 'rejected', 'withdrawn')");

                            t.HasCheckConstraint("ck_leave_requests_type", "type IN ('annual', 'sick', 'emergency', 'shift_swap')");
                        });
                });

            modelBuilder.Entity("CareLanka.Api.Data.Entities.Staff.Shift", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("RequiredSkillId")
                        .HasDatabaseName("ix_shifts_required_skill_id");

                    b.HasIndex("WardId", "Date")
                        .HasDatabaseName("ix_shifts_ward_date");

                    b.ToTable("shifts", null, t =>
                        {
                            t.HasCheckConstraint("ck_shifts_headcount", "headcount_needed > 0 AND minimum_headcount > 0 AND minimum_headcount <= headcount_needed");

                            t.HasCheckConstraint("ck_shifts_required_role", "required_role IN ('ward_nurse', 'doctor', 'ambulance_crew', 'general_staff', 'duty_manager', 'hospital_administrator', 'equipment_manager')");
                        });
                });

            modelBuilder.Entity("CareLanka.Api.Data.Entities.Staff.Skill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CareLanka.Api.Data.Entities.Staff.StaffMemberSkill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_staff_member_skills");

                    b.HasIndex("SkillId")
                        .HasDatabaseName("ix_staff_member_skills_skill_id");

                    b.HasIndex("StaffMemberId", "SkillId")
                        .IsUnique()
                        .HasDatabaseName("ux_staff_member_skills_staff_skill");

                    b.ToTable("staff_member_skills", (string)null);
                });

            modelBuilder.Entity("CareLanka.Api.Data.Entities.Staff.WardStaffingRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_ward_staffing_rules");

                    b.HasIndex("RequiredSkillId")
                        .HasDatabaseName("ix_ward_staffing_rules_required_skill_id");
            ...
            modelBuilder.Entity("CareLanka.Api.Data.Entities.Equipment.ReorderSuggestion", b =>
                {
                    b.HasOne("CareLanka.Api.Data.Entities.Equipment.PharmacyItem", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_reorder_suggestions_pharmacy_items_pharmacy_item_id");
                });
            ...
            modelBuilder.Entity("CareLanka.Api.Data.Entities.Staff.Allocation", b =>
                {
                    b.HasOne("CareLanka.Api.Data.Entities.Common.StaffMember", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_allocations_staff_members_created_by_staff_id");

                    b.HasOne("CareLanka.Api.Data.Entities.Staff.Allocation", "ReplacedByAllocation")
                        .WithMany()
                        .HasForeignKey("ReplacedByAllocationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_allocations_allocations_replaced_by_allocation_id");

                    b.HasOne("CareLanka.Api.Data.Entities.Staff.Shift", "Shift")
                        .WithMany("Allocations")
                        .HasForeignKey("ShiftId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_allocations_shifts_shift_id");
                    ...
                    b.HasOne("CareLanka.Api.Data.Entities.Common.StaffMember", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_allocations_staff_members_staff_member_id");

                    b.Navigation("ReplacedByAllocation");
            ...
            modelBuilder.Entity("CareLanka.Api.Data.Entities.Staff.LeaveRequest", b =>
                {
                    b.HasOne("CareLanka.Api.Data.Entities.Common.StaffMember", null)
                        ...
                        .HasForeignKey("ReviewedByStaffMemberId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_leave_requests_staff_members_reviewed_by_staff_member_id");
                    ...
                    b.HasOne("CareLanka.Api.Data.Entities.Common.StaffMember", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_leave_requests_staff_members_staff_member_id");

                    b.HasOne("CareLanka.Api.Data.Entities.Staff.Shift", "SwapShift")
                        .WithMany()
                        .HasForeignKey("SwapShiftId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_leave_requests_shifts_swap_shift_id");

                    b.HasOne("CareLanka.Api.Data.Entities.Common.StaffMember", null)
                        .WithMany()
                        .HasForeignKey("SwapWithStaffMemberId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_leave_requests_staff_members_swap_with_staff_member_id");
            ...
            modelBuilder.Entity("CareLanka.Api.Data.Entities.Staff.Shift", b =>
                {
                    b.HasOne("CareLanka.Api.Data.Entities.Staff.Skill", "RequiredSkill")
                        .WithMany("Shifts")
                        .HasForeignKey("RequiredSkillId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_shifts_skills_required_skill_id");
            ...
            modelBuilder.Entity("CareLanka.Api.Data.Entities.Staff.StaffMemberSkill", b =>
                {
                    b.HasOne("CareLanka.Api.Data.Entities.Staff.Skill", "Skill")
                        .WithMany("StaffMemberSkills")
                        .HasForeignKey("SkillId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_staff_member_skills_skills_skill_id");
                    ...
                    b.HasOne("CareLanka.Api.Data.Entities.Common.StaffMember", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_staff_member_skills_staff_members_staff_member_id");
            ...
            modelBuilder.Entity("CareLanka.Api.Data.Entities.Staff.WardStaffingRule", b =>
                {
                    b.HasOne("CareLanka.Api.Data.Entities.Staff.Skill", "RequiredSkill")
                        .WithMany("WardStaffingRules")
                        .HasForeignKey("RequiredSkillId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ward_staffing_rules_skills_required_skill_id");
            ...
            modelBuilder.Entity("CareLanka.Api.Data.Entities.Staff.Skill", b =>
                {
                    ...
                    b.Navigation("WardStaffingRules");
                });
