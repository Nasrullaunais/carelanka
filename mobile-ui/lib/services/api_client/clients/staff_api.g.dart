...
class _StaffApi implements StaffApi {
  ...
  Future<List<CrewCandidate>> searchAvailableCrew({String? search}) async {
    ...
    final _options = _setStreamType<List<CrewCandidate>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/staff/crew-candidates',
    ...
    late List<CrewCandidate> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => CrewCandidate.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
